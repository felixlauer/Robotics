    ...
    for j in range(num_joints):
        for i in range(num_points):
            if i == 0 or i == num_points - 1:
                # Constrain initial and final velocities to zero
...
filename_joint = "csh_jointspace.png"
...
filename_cart = "csh_cartesianspace.png"
...
# Autosave 3D Path
filename_3d = "csh_trajectory_3d.html"
