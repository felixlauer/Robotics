...
# --- 4. PIZZA COORDINATES & PLAN (Sparse Version) ---
cartesian_list = np.array([
    [2.300, -0.050, 1.050], # 1. Start (Under Pizza)
    [2.300, -0.050, 1.070], # 2. Lift
    [2.204, -0.015, 1.070], # 3. Arc High
    [2.152,  0.074, 1.070], # 4
    [2.152,  0.126, 1.070], # 5
    [2.204,  0.215, 1.070], # 6
    [2.300,  0.250, 1.070], # 7. Arc High End (Rotated)
    [2.300,  0.250, 1.050], # 8. Lower (Place)
    [2.204,  0.215, 1.050], # 9. Arc Low
    [2.152,  0.126, 1.050], # 10
    [2.152,  0.074, 1.050], # 11
    [2.204, -0.015, 1.050], # 12
    [2.300, -0.050, 1.050]  # 13. Arc Low End (Reset)
])
